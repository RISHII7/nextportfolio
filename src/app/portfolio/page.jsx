...
const items = [
  ...
  },
  {
    ...
    desc: "My very own portfolio where i've mentioned my  projects and skills .",
    img: "/project3.png",
    link: "https://react-portfolio-rishi.vercel.app/",
  },
  {
    id: 4,
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex flex-col gap-8 text-white">
                  ...
                  <p className="w-80 md:w96 lg:w-[500px] lg:text-lg xl:w-[600px] self-center">
                    {item.desc}
                  </p>
                  <Link href={item.link} className="flex justify-center">
                    <button className="p-2 text-sm md:p-4 md:text-md lg:p-8 lg:text-lg bg-white text-gray-600 font-semibold m-4 rounded-2xl">See Demo</button>
                  </Link>
                </div>
              </div>
            ))}
